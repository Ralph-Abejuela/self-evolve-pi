...
const ROOT = "C:\\Users\\ExWaltzPC\\Documents\\Git-Clones\\self-evolve-pi";
const FIXTURE = join(ROOT, "test-fixture");
const SESSIONS = "C:\\Users\\ExWaltzPC\\.pi\\agent\\sessions";
const EXT = join(ROOT, "self-evolve", "index.ts");
const PROJ_DIR_NAME = "--C--Users-ExWaltzPC-Documents-Git-Clones-self-evolve-pi--";
